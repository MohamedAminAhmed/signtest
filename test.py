...
for folder in os.listdir('C:/Users/moham/OneDrive/سطح المكتب/test'):
    if folder == "done":
        shutil.rmtree("C:/Users/moham/OneDrive/سطح المكتب/test/done")
    else:
        continue
...
input_path = 'C:/Users/moham/OneDrive/سطح المكتب/test/test2.mp4'
...
# Perform prediction
results = model.predict(source=input_path, conf=0.5, stream=True, save=True, vid_stride=length, show=True, save_crop=True, project='C:/Users/moham/OneDrive/سطح المكتب/test', name='done')
...
for folder in os.listdir('C:/Users/moham/OneDrive/سطح المكتب/test/done/crops'):
